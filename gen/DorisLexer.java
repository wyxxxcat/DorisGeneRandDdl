// Generated from /mnt/disk2/wangyixuan/DorisParser/DorisLexer.g4 by ANTLR 4.13.2
...
public class DorisLexer extends Lexer {
	...
	public static final int
		...
		MATCH_PHRASE_PREFIX=276, MATCH_REGEXP=277, MATERIALIZED=278, MAX=279, 
		MAXVALUE=280, MEMO=281, MERGE=282, MIGRATE=283, MIGRATIONS=284, MIN=285, 
		MINUS=286, MINUTE=287, MODIFY=288, MONTH=289, MTMV=290, NAME=291, NAMES=292, 
		NATURAL=293, NEGATIVE=294, NEVER=295, NEXT=296, NGRAM_BF=297, NO=298, 
		NO_USE_MV=299, NON_NULLABLE=300, NOT=301, NULL=302, NULLS=303, OBSERVER=304, 
		OF=305, OFFSET=306, ON=307, ONLY=308, OPEN=309, OPTIMIZED=310, OR=311, 
		ORDER=312, OUTER=313, OUTFILE=314, OVER=315, OVERWRITE=316, PARAMETER=317, 
		...
		PAUSE=327, PERCENT=328, PERIOD=329, PERMISSIVE=330, PHYSICAL=331, PI=332, 
		PLACEHOLDER=333, PLAN=334, PLAY=335, PRIVILEGES=336, PROCESS=337, PLUGIN=338, 
		PLUGINS=339, POLICY=340, PRECEDING=341, PREPARE=342, PRIMARY=343, PROC=344, 
		PROCEDURE=345, PROCESSLIST=346, PROFILE=347, PROPERTIES=348, PROPERTY=349, 
		QUANTILE_STATE=350, QUANTILE_UNION=351, QUERY=352, QUEUED=353, QUOTA=354, 
		QUALIFY=355, QUARTER=356, RANDOM=357, RANGE=358, READ=359, REAL=360, REBALANCE=361, 
		RECENT=362, RECOVER=363, RECYCLE=364, REFRESH=365, REFERENCES=366, REGEXP=367, 
		RELEASE=368, RENAME=369, REPAIR=370, REPEATABLE=371, REPLACE=372, REPLACE_IF_NOT_NULL=373, 
		REPLAYER=374, REPLICA=375, REPOSITORIES=376, REPOSITORY=377, RESOURCE=378, 
		RESOURCES=379, RESTORE=380, RESTRICTIVE=381, RESUME=382, RETURNS=383, 
		REVOKE=384, REWRITTEN=385, RIGHT=386, RLIKE=387, ROLE=388, ROLES=389, 
		ROLLBACK=390, ROLLUP=391, ROUTINE=392, ROW=393, ROWS=394, S3=395, SAMPLE=396, 
		SCHEDULE=397, SCHEDULER=398, SCHEMA=399, SCHEMAS=400, SECOND=401, SELECT=402, 
		SEMI=403, SERIALIZABLE=404, SESSION=405, SESSION_USER=406, SET=407, SETS=408, 
		SET_SESSION_VARIABLE=409, SHAPE=410, SHOW=411, SIGNED=412, SKEW=413, SMALLINT=414, 
		SNAPSHOT=415, SONAME=416, SPLIT=417, SQL=418, SQL_BLOCK_RULE=419, STAGE=420, 
		STAGES=421, START=422, STARTS=423, STATS=424, STATUS=425, STOP=426, STORAGE=427, 
		STREAM=428, STREAMING=429, STRING=430, STRUCT=431, SUM=432, SUPERUSER=433, 
		SWITCH=434, SYNC=435, SYSTEM=436, TABLE=437, TABLES=438, TABLESAMPLE=439, 
		TABLET=440, TABLETS=441, TASK=442, TASKS=443, TEMPORARY=444, TERMINATED=445, 
		TEXT=446, THAN=447, THEN=448, TIME=449, TIMESTAMP=450, TINYINT=451, TO=452, 
		TRANSACTION=453, TRASH=454, TREE=455, TRIGGERS=456, TRIM=457, TRUE=458, 
		TRUNCATE=459, TYPE=460, TYPECAST=461, TYPES=462, UNBOUNDED=463, UNCOMMITTED=464, 
		UNINSTALL=465, UNION=466, UNIQUE=467, UNLOCK=468, UNSET=469, UNSIGNED=470, 
		UP=471, UPDATE=472, USE=473, USER=474, USE_MV=475, USING=476, VALUE=477, 
		VALUES=478, VARCHAR=479, VARIABLE=480, VARIABLES=481, VARIANT=482, VAULT=483, 
		VAULTS=484, VERBOSE=485, VERSION=486, VIEW=487, VIEWS=488, WARM=489, WARNINGS=490, 
		WEEK=491, WHEN=492, WHERE=493, WHITELIST=494, WITH=495, WORK=496, WORKLOAD=497, 
		WRITE=498, XOR=499, YEAR=500, EQ=501, NSEQ=502, NEQ=503, LT=504, LTE=505, 
		GT=506, GTE=507, PLUS=508, SUBTRACT=509, ASTERISK=510, SLASH=511, MOD=512, 
		TILDE=513, AMPERSAND=514, LOGICALAND=515, LOGICALNOT=516, PIPE=517, DOUBLEPIPES=518, 
		HAT=519, COLON=520, ARROW=521, HINT_START=522, HINT_END=523, COMMENT_START=524, 
		ATSIGN=525, DOUBLEATSIGN=526, STRING_LITERAL=527, LEADING_STRING=528, 
		BIGINT_LITERAL=529, SMALLINT_LITERAL=530, TINYINT_LITERAL=531, INTEGER_VALUE=532, 
		EXPONENT_VALUE=533, DECIMAL_VALUE=534, BIGDECIMAL_LITERAL=535, IDENTIFIER=536, 
		BACKQUOTED_IDENTIFIER=537, SIMPLE_COMMENT=538, BRACKETED_COMMENT=539, 
		FROM_DUAL=540, WS=541, UNRECOGNIZED=542;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"NAMES", "NATURAL", "NEGATIVE", "NEVER", "NEXT", "NGRAM_BF", "NO", "NO_USE_MV", 
			"NON_NULLABLE", "NOT", "NULL", "NULLS", "OBSERVER", "OF", "OFFSET", "ON", 
			"ONLY", "OPEN", "OPTIMIZED", "OR", "ORDER", "OUTER", "OUTFILE", "OVER", 
			...
			"PATH", "PAUSE", "PERCENT", "PERIOD", "PERMISSIVE", "PHYSICAL", "PI", 
			"PLACEHOLDER", "PLAN", "PLAY", "PRIVILEGES", "PROCESS", "PLUGIN", "PLUGINS", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'NEVER'", "'NEXT'", "'NGRAM_BF'", "'NO'", "'NO_USE_MV'", "'NON_NULLABLE'", 
